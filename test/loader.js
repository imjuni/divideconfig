...
describe('loader', function () {
  ...
  it('loader_walk_production_default_development_yaml', function () {
    var configuration = loader.loading(path.join(__dirname, '../config/production_default_development_yaml'), 'config.yaml');
